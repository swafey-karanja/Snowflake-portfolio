      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            If you have any questions or would like to collaborate, please do not hesitate to reach out to me!
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="reveal-up w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        <div className="w-full lg:pl-12">
            <form
              action="https://getform.io/f/bgddyzya"
              method="POST"
              className="w-full"
            >
              <div className="md:grid md:grid-cols-2 md:gap-4">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    placeholder="snowflake@example.com"
                    className="text-field reveal-up"
                  />
                </div>
              </div>
